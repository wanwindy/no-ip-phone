...
const create_outbound_call_dto_1 = require("./dto/create-outbound-call.dto");
...
let CallsController = class CallsController {
    ...
    async createOutboundCall(request, body) {
        return this.callsService.createOutboundCall(request.user, body);
    }
    async getCall(request, id) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, create_outbound_call_dto_1.CreateOutboundCallDto]),
