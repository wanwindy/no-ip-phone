...
type SeedSummary = {
  logins: Array<{
    ...
    selectableTenantIds: string[];
    selectableTenantCodes: string[];
  }>;
  tenants: Array<{
    id: string;
    code: string;
...
async function assertTablesExist(client: PgClient): Promise<void> {
...
async function upsertAccounts(client: PgClient): Promise<void> {
  const [sharedSwitcherPasswordHash, betaOwnerPasswordHash] =
    await Promise.all([
...
async function upsertTenants(client: PgClient): Promise<void> {
  await client.query(`
    INSERT INTO tenants (
      id,
      code,
...
async function upsertTenantMembers(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertDidInventory(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertAssignments(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertEndpoints(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertCallSessions(client: PgClient): Promise<void> {
  await client.query(`
...
async function linkInboundCallToCallbackSession(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertCallbackSessions(client: PgClient): Promise<void> {
  await client.query(`
...
async function upsertCallEvents(client: PgClient): Promise<void> {
  await client.query(`
